...
from govstack_api.building_blocks.bb_digital_registries.views.single_field_view import SingleFieldView
...
urlpatterns = [
    ...
    path('data/<str:registryname>/<str:versionnumber>/<str:uuid>/read-value/<str:field>.<ext>',
         SingleFieldView.as_view(), name="read_field_from_registry_record"),
